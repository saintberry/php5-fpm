...
attribute :listen_allowed_clients, :kind_of => Array, :required=> false, :default => nil
...
attribute :request_slowlog_timeout, :kind_of => Integer, :required => false, :default => nil
attribute :request_terminate_timeout, :kind_of => Integer, :required => false, :default => nil
...
attribute :security_limit_extensions, :kind_of => Array, :required => false, :default => nil
